...
type UserAgent struct {
	ua           string
	mozilla      string
	platform     string  // default "UNKONWN"
	os           string  // default "UNKONWN"
	localization string  // default "UNKONWN"
	browser      Browser // default "UNKONWN"
	bot          bool
	undecided    bool

	mobile      bool   // the following only available for mobile
	mobilebrand string // default "UNKONWN"
	mobilemodel string // default "UNKONWN"
	devicetype  string // default "UNKONWN"
}
...
func New(ua string) *UserAgent {
	...
	if o.browser.Engine == "" {
		o.browser.Engine = "Unknown"
	}
	//if o.browser.EngineVersion == "" {
	//	o.browser.EngineVersion = "Unknown"
	//}
	if o.browser.Name == "" {
		o.browser.Name = "Unknown"
	}
	//if o.browser.Version == "" {
	//	o.browser.Version = "Unknown"
	//}
	if o.mobilebrand == "" || o.mobilebrand == "Unknown" {
		o.mobilebrand = getBrand(o.mobilemodel)
	}
	return o
}
