...
type Browser struct {
	...
	Engine        string // default "UNKONWN"

			     // The version of the browser's engine.
	EngineVersion string // default "UNKONWN"

			     // The name of the browser.
	Name          string // default "UNKONWN"

			     // The version of the browser.
	Version       string // default "UNKONWN"
}
			...
			if engine.name == "AppleWebKit" {
				...
				default:
					if sections[sectionIndex].name == "Chrome" {
						...
						if sections[slen - 2].name == "MQQBrowser" {
							p.browser.Name = "MQQBrowser"
